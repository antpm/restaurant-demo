...
export default function About() {
    ...
    return (
        <div className='flex flex-col w-full  items-center mt-16 gap-16'>
            <p className={`${showDesc ? 'opacity-100' : 'opacity-0'} transition-all duration-1000 md:text-lg md:w-1/2 w-11/12`}>
                ...
                Vestibulum porta luctus faucibus. Mauris vel nibh dolor. Phasellus eu mi gravida, accumsan nulla id, facilisis massa. Nulla ornare id
                sem sit amet lacinia. Quisque interdum urna non urna vulputate aliquam.
            </p>
